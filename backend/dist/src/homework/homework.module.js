...
exports.HomeworkModule = HomeworkModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([homework_entity_1.Homework, homework_attachment_entity_1.HomeworkAttachment, submission_entity_1.Submission, lesson_entity_1.Lesson, user_entity_1.User])],
