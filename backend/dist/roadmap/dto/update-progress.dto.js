...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Lesson status', enum: lesson_entity_1.LessonStatus }),
    (0, class_validator_1.IsEnum)(lesson_entity_1.LessonStatus),
    __metadata("design:type", String)
], UpdateProgressDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Progress percentage (0-100)', required: false }),
