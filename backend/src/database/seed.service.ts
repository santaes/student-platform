...
export class SeedService {
  ...
  private async createResources() {
    const resources = [
      ...
      {
        title: 'Spanish for Beginners - Basic Phrases',
        description: 'Essential Spanish phrases for beginners including greetings, introductions, and common expressions',
        category: 'Español',
        fileName: 'spanish-for-beginners.txt',
        originalName: 'Spanish for Beginners - Basic Phrases.txt',
        mimeType: 'text/plain',
        fileSize: 5120,
        fileUrl: '/resources/spanish-for-beginners.txt',
        filePath: '/uploads/spanish-for-beginners.txt',
      },
      {
        title: 'Spanish Verbs - Essential Conjugations',
        description: 'Complete guide to Spanish verb conjugations including regular and irregular verbs',
        category: 'Español',
        fileName: 'spanish-verbs-guide.txt',
        originalName: 'Spanish Verbs - Essential Conjugations.txt',
        mimeType: 'text/plain',
        fileSize: 8192,
        fileUrl: '/resources/spanish-verbs-guide.txt',
        filePath: '/uploads/spanish-verbs-guide.txt',
      },
      {
        title: 'Spanish Vocabulary Builder',
        description: 'Comprehensive Spanish vocabulary covering family, food, colors, animals, places, and more',
        category: 'Español',
        fileName: 'spanish-vocabulary.txt',
        originalName: 'Spanish Vocabulary Builder.txt',
        mimeType: 'text/plain',
        fileSize: 6144,
        fileUrl: '/resources/spanish-vocabulary.txt',
        filePath: '/uploads/spanish-vocabulary.txt',
      },
      {
      ...
      {
        title: 'Повний посібник українських дієслів',
        description: 'Детальний посібник з українських дієслів та їх відмінювань',
        category: 'Українська',
        fileName: 'ukrainian-verbs.pdf',
        originalName: 'ukrainian-verbs.pdf',
        mimeType: 'application/pdf',
        fileSize: 2048576,
        fileUrl: '/resources/ukrainian-verbs.pdf',
        filePath: '/uploads/ukrainian-verbs.pdf',
      },
      {
        title: 'Український словник для початківців',
        description: 'Базовий словник української мови для початківців',
        category: 'Українська',
        fileName: 'ukrainian-dictionary.pdf',
        originalName: 'ukrainian-dictionary.pdf',
        mimeType: 'application/pdf',
        fileSize: 128716,
        fileUrl: '/resources/ukrainian-dictionary.pdf',
        filePath: '/uploads/ukrainian-dictionary.pdf',
      },
    ];
